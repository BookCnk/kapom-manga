...
import { ArrowLeft, ArrowRight, ChevronLeft, ChevronRight, Home, Share2, Settings, MessageCircle } from "lucide-react";
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="w-full max-w-4xl text-center">
            ...
            {chapter.title.includes("(") && (
              <p className="text-muted-foreground">({chapter.title.match(/\(([^)]+)\)/)?.[1]})</p>
            )}
          </div>
          ...
          {/* Comments Section */}
          <div className="w-full max-w-4xl border-t border-border pt-6 mt-6">
