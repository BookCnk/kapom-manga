...
const stats = [
  { label: "ผลงานทั้งหมด", value: "12", icon: FileText, color: "text-blue-500" },
  { label: "คอมมิชชั่น", value: "8", icon: DollarSign, color: "text-green-500" },
  { label: "ผู้ใช้", value: "256", icon: Users, color: "text-purple-500" },
  { label: "ยอดเข้าชม", value: "1.2k", icon: BarChart3, color: "text-orange-500" },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">สถิติและข้อมูลสำคัญ</p>
      </div>
