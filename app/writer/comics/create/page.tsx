        ...
        if (nsfwModel) {
          try {
            ...
            if (nsfwScore > 0.5 && !formData.isMature) {
              toast.error("ตรวจพบเนื้อหา 18+ ในภาพ กรุณาเปลี่ยนภาพหรือตั้งค่าระดับเนื้อหาเป็น 18+");
              setCoverPreview(null);
              setFormData((prev) => ({ ...prev, coverUrl: "" }));
              if (fileInputRef.current) fileInputRef.current.value = "";
              setCoverError("ภาพนี้มีเนื้อหา 18+ กรุณาเปลี่ยนภาพหรือตั้งค่าระดับเนื้อหาเป็น 18+");
                ...
                {checkingNsfw ? (
                  ...
                  <>
                    ...
                    <div className="text-center px-4">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">(500x700 px)</p>
                    </div>
                  </>
                )}
              </div>
